...
describe AccountTest do
  context 'validations' do
    ...
    it 'increases progress correctly when test is completed' do
      ...
      account_test = AccountTest.find_or_create_by(test_completed: false, correct_questions: 0, account_id: 1,
                                                   test_id: 1)
      account_test.save
    ...
    it 'updates the test_completed attribute based on the well_answered questions' do
